      ...
      <AppBar sx={{ paddingX: 20, paddingY: 2, backgroundColor: "transparent", color: "black", boxShadow: "none" }} position="static">
        <Toolbar >
          ...
          <Box  sx={{  display: { xs: 'none', md: 'flex' }, gap: "15px", alignItems: "center" }}>
            <Button sx={{ backgroundColor: "#047857", borderRadius: "15px", paddingX: "24px", paddingY: "12px", color: "white", '&:hover': { backgroundColor: '#047857' } }}>Login</Button>
            <Button sx={{ backgroundColor: "#047857", borderRadius: "15px", paddingX: "24px", paddingY: "12px", color: "white", '&:hover': { backgroundColor: '#047857' } }}>Sign Up</Button>
          </Box>
        </Toolbar>
      </AppBar>
    </>
