    ...
    <Grid container sx={{ height: '100vh', overflow: 'hidden' }}>
      <Grid item xs={12} md={6} sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', overflow: 'auto' }}>
        <Box sx={{ p: 4, borderRadius: 2, display: 'flex', flexDirection: 'column', alignItems: 'center', maxWidth: 600, width: '100%' }}>
          <Typography variant="h4" component="h2" sx={{ fontWeight: 'bold', mb: 2 }}>Customer Login</Typography>
          <Formik
          ...
          <Box sx={{ display: "flex", justifyContent: "space-between", width: "100%" }}>
            <Typography  sx={{ mt: { xs: 2, md: 4 }  , fontSize:{xs:"10px" , sm:"15px" , md:"20px" , lg:"20px"}}}>
              <Link href="/forgot-password" color="inherit">Forgot Password?</Link>
            </Typography>
            <Typography  sx={{ mt: { xs: 2, md: 4 } ,fontSize:{xs:"10px" , sm:"15px" , md:"20px" , lg:"20px"} }}>
              Don't have an account? <Link href="/admin/register" color="inherit">Register</Link>
            </Typography>
          </Box>
        </Box>
      </Grid>
      <Grid item xs={false} sm={false} md={6} sx={{ display:{xs:"none" , sm:"none" , md:"flex" , lg:"flex"}, alignItems: 'center', justifyContent: 'center', height: '100vh' }}>
        <Box
          sx={{
            width: '100%',
            height: '100%',
