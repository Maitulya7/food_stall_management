...
const DashboardGrid = ({ onTabChange }) => {
  ...
  return (
    <Grid container spacing={3}>
      <Grid item xs={12} sm={6} md={3} onClick={() => handleTabClick('Orders')} style={{ cursor: 'pointer' }}>
        <DashboardBox label="Orders" color="#4caf50" selected={selectedTab === 'Orders'} icon={<ShoppingCart fontSize='large' />} />
      </Grid>
